...
* Understand how to use/read API documentation.
* Learn how to pull data from API.
* Learn how to select and execute API commands.
* Wrangle data to usable form (like csv or a graph).
...
* Download Rentrez and learn basic search commands.
...
In this section we are going to explore the functions: 
...
The entrez_summary function takes 7 arguments but you don't need to use them all.

------------------------------------------------------------------------

List of entrez_summary arguments:
