...
Remember that you can always use the ``helper(<function>)`` in R to search function descriptions. 
...
The syntax of this fuction is similar to the entrez_summary function. 
...
#<YOUR ANSWER HERE> <- entrez_global_query(<YOUR ANSWER HERE>)
...
#<YOUR ANSWER HERE> <-entrez_link(<YOUR ANSWER HERE>)
