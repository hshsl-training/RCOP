...
library(readr)
#| message: FALSE
Workshop01 <- read_csv("data/Workshop01.csv")
...
```{r}
#| message: FALSE
Workshop02 <- read_csv("data/Workshop02.csv")

Workshop03 <- read_csv("data/Workshop03.csv")

Workshop04 <- read_csv("data/Workshop04.csv")
```
...
write_csv(all_workshops, "data_output/all_workshops.csv")

saveRDS(all_workshops, "data_output/all_workshops.RDS")


write_csv(workshop_breakdown, "data_output/workshop_breakdown.csv")
